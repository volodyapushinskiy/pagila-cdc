...
Учебный проект: потоковый пайплайн на основе **Change Data Capture** (CDC) — технологии, которая перехватывает каждое изменение в базе данных и доставляет его в аналитическое хранилище в режиме реального времени.
